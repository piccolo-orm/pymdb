...
MOVIES = [
    ...
    },
    {
        ...
        "director": 9,
        "description": (
            "An FBI agent boards a flight, escorting a witness to trial. "
            "An on-board assassin releases a crate of deadly serpents in an "
            "attempt to kill the witness."
        ),
        "release_date": datetime.datetime(year=2014, month=12, day=1),
        "oscar_nominations": 0,
        "won_oscar": False,
        "box_office": Decimal("62.0"),
